...
logistic_roc = linear_regression(training_data = model_data$combined_data,
                                   testing_x = model_data$testing_x,
                                   testing_y = model_data$testing_y)  
...
ridge_roc = elastic_net_regression(training_x = model_data$training_x,
                                 training_y = model_data$training_y,
                                 testing_x = model_data$testing_x,
                                 testing_y = model_data$testing_y, 
                                 a = 0,
                                 folds = 5,
...
lasso_roc = elastic_net_regression(training_x = model_data$training_x,
                                 training_y = model_data$training_y,
                                 testing_x = model_data$testing_x,
                                 testing_y = model_data$testing_y, 
                                 a = 1,
...
elastic_net_roc = elastic_net_regression(training_x = model_data$training_x,
                                 training_y = model_data$training_y,
                                 testing_x = model_data$testing_x,
                                 testing_y = model_data$testing_y, 
                                 a = 1,
...
LDA_roc = LDA_regression(training_data = model_data$combined_data,
                                   testing_x = model_data$testing_x,
                                   testing_y = model_data$testing_y)
...
randomforest_roc = random_forest_ranger(training_data = model_data$combined_data,
...
xgboost_roc = xgboost_parallel(training_x = model_data$training_x,
                               training_y = model_data$training_y,
                               testing_x = model_data$testing_x,
                               testing_y = model_data$testing_y,
                               learning_rate = 0.2,
